...
Este proyecto implementa una suite de pruebas automáticas para la aplicación web Sauce Demo, utilizando Playwright con Cucumber, y aplicando el patrón de diseño Page Object Model (POM).
...
4. Ejecutar solo un grupo de escenarios (tags)
...
Se implementó el patrón Page Object Model (POM) para mantener separado el flujo de la lógica de las páginas.

Cada acción del usuario está representada en un archivo .feature y es implementada en los archivos de steps/.

Se aplicó tags para ejecutar escenarios de manera independiente.
...
Esto permite observar visualmente la ejecución paso a paso de cada prueba.
